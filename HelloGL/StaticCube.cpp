...
StaticCube::StaticCube(Mesh* mesh, Texture2D* texture, float x, float y, float z) : SceneObject(mesh, texture)
{
	//set the position & rotation variables
	_position.x = x;
	_position.y = y;
	_position.z = z;
	_rotation = 0.0f;
...
StaticCube::~StaticCube(void) //Destructor
{
